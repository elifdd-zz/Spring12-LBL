...
#PBS -V
#PBS -j oe
#PBS -l walltime=00:06:30
#PBS -N labelling-mongodb
#PBS -A m1104 
#PBS -S /bin/bash
...
export inputdir="/scratch/scratchdirs/edede/MyHadoop/hadoop-data/input/ZachsBenchMarkData/censusdata/small-census"
#censusdata.sample"
